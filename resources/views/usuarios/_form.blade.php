@csrf
    <div class="form-group">
        ...
        <input  class="form-control @error('VC_DNI') is-invalid @enderror " @if (isset($task) && $task == 'edit') disabled @endif type="text" name="VC_DNI" id="VC_DNI" value="{{ old("VC_DNI",$persona->VC_DNI)}}"  >
        @error('VC_DNI')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
        </span>
        ...
        @if (isset($task) && $task == 'edit')
            ...
            <select  class="custom-select rounded-0" name="BT_ESTADO_FILA" id="BT_ESTADO_FILA">
